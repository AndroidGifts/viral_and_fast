...
ActiveRecord::Schema.define(version: 20160114092205) do
  ...
  add_index "categories_editors", ["category_id", "editor_id"], name: "index_categories_editors_on_category_id_and_editor_id"
  ...
  add_index "editors", ["confirmation_token"], name: "index_editors_on_confirmation_token", unique: true
  ...
  add_index "editors", ["unlock_token"], name: "index_editors_on_unlock_token", unique: true
